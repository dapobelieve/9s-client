...
<g>
    <g>
        ...
        <div class="container mx-auto sm:px-4 pb-8 pt-6">
            <div class="bg-white border border-t border-b sm:border-l sm:border-r sm:rounded shadow mb-6">
                <div class="border-b px-6">
                    <div class="flex justify-between -mb-px">
                        <div class="sm:hidden text-blue-900 py-4 text-xl">
                            Price Charts
                        </div>
                        <div class="hidden currency sm:flex">
                            <button class="appearance-none py-4 text-blue-400 border-b border-blue-800 mr-4">
                                Bitcoin &middot; CAD $21300.01
                            </button>
                            <button class="appearance-none py-4 text-gray-900 border-transparent hover:border-gray-600 border-b mr-4">
                                Ethereum &middot; CAD $884.80
                            </button>
                            <button class="appearance-none py-4 text-gray-900 border-transparent hover:border-gray-600 border-b">
                                LiteCoin &middot; CAD $344.80
                            </button>
                        </div>
                        <div class="timeline flex text-sm">
                            <button class="appearance-none py-4 text-gray-900 border-b hover:border-gray-600 mr-4">
                                1H
                            </button>
                            <button class="appearance-none py-4 text-gray-900 border-b hover:border-gray-600 mr-4">
                                1D
                            ...
                            <button class="appearance-none py-4 text-gray-900border-b hover:border-gray-600 mr-4">
                                1M
                            </button>
                            <button class="appearance-none py-4 text-gray-900 border-b hover:border-gray-600 mr-4">
                                1Y
                            </button>
                            <button class="appearance-none py-4 text-gray-900 border-b hover:border-gray-600">
                                ALL
                            </button>
                        </div>
                    </div>
                </div>
                <div class="flex px-6 items-center sm:hidden">
                    <div class="flex-1 py-6">
                        <div class="text-gray-900 mb-2">
                            <span class="text-3xl align-top">CA$</span>
                            <span class="text-5xl">21,890</span>
                            <span class="text-3xl align-top">.90</span>
                        </div>
                    </div>
                    <div>
                        <select>
                ...
                <div class="hidden sm:flex items-center">
                    <div class="w-1/3 text-center py-6">
                        <div class="border-r">
                            ...
                            <div class="uppercase text-gray-400 tracking-wide">Bitcoin Price</div>
                        </div>
                    </div>
                    <div class="w-1/3 text-center py-6">
                        <div class="border-r">
                            <div class="text-gray-900 mb-2">
                                ...
                                <span class="text-5xl">78,890</span>
                                <span class="text-3xl align-top">.90</span>
                            </div>
                            <div class="uppercase text-gray-400 tracking-wide">Since last month (cad)</div>
                        </div>
                    </div>
                    <div class="w-1/3 text-center py-6">
                        <div >
                            ...
                            <div class="uppercase text-gray-400 tracking-wide">Since last month (%)</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="flex flex-wrap -mx-1">
                <div class="w-1/2 px-4">
                    <div class="bg-white rounded shadow border">
                        <div class="flex border-b justify-between px-6 items-center -mb-px">
                            <h3 class="py-4 text-blue-800 font-normal text-lg">Your Portfolio</h3>
                            <div>
                                <button class="appearance-none py-4 text-gray-900 border-b border-blue-800 hover:border-gray-600 mr-4">
                                    List
                                </button>
                                <button class="appearance-none py-4 text-gray-900 border-b hover:border-gray-600">
                                    Demo
                ...
                <div class="w-1/2 px-6 sm:px-4">
                    <div class="bg-white rounded border shadow">
                        asf;hjkhfas adfjksdahfj
                    </div>
                </div>
            </div>
        </div>
