<template>
  <div
    class="landing text-left flex flex-col justify-between"
  ...
  >
    ...
    <div class="lower-content p-6 md:p-16">
      ...
      <div class>
        <button
          class="bg-green-500 text-white font-bold py-2 px-4 m-2 focus:outline-none rounded"
        >Watch Stream</button>
        <button
          class="bg-transparent-500 py-2 px-4 m-2 text-white border hover:bg-white hover:text-green-500 border-solid border-white-800 font-bold py-2 px-4 rounded"
